...
<body>
	...
	<nav id="menu" class="left">
		<ul>
			...
			<li><a href="#"><i class="fa fa-header"></i>Holon<i
					class="fa fa-caret-down"></i></a>
				<ul>
					<li><a href="#" id="showHolonObjects"><i
							class="fa fa-info-circle"></i>Show Holons</a></li>
				</ul></li>
			<li><a href="#"><i class="fa fa-institution"></i>Holon
					Object<i class="fa fa-caret-down"></i></a>
				<ul>
					<li><a href="#" id="addHolonObject"><i class="fa fa-plus"></i>Add
							Holon Object</a></li>
					<li><a href="#" id="connectToPowerSource"><i
							class="fa fa-plug"></i>Connect To Main Line</a></li>
					<li><a href="#" id="areConnected"><i
							class="fa fa-exchange"></i>Are Connected ?</a></li>
				</ul></li>
			<li><a href="#"><i class="fa  fa-certificate"></i>Power
					Source<i class="fa fa-caret-down"></i></a>
				<ul>
					<li><a href="#" id="addPowerSource"><i class="fa fa-plus"></i>Add
							Power Source</a></li>
					<li><a href="#" id="connectPowerSource"><i
							class="fa fa-plug"></i>Connect Power Source</a></li>
				</ul></li>

			<li><a href="#"><i class="fa fa-flash"></i>Power Line<i
					class="fa fa-caret-down"></i></a>
				<ul>
					<li><a href="#" id="addPowerLine"><i
							class="fa fa-long-arrow-right"></i>Draw PowerLine</a></li>
					<li><a href="#" id="calcDistance"><i
							class="fa fa-arrows-h"></i>Calculate Distance</a></li>
				</ul></li>
			<li><a href="#"><i class="fa fa-toggle-on"></i>Switch<i
					class="fa fa-caret-down"></i></a>
				<ul>
					<li><a href="#" id="switchOnPowerLine"><i
							class=" fa fa-life-saver "></i>Switch on Power Line</a></li>
				</ul></li>
			<li><a href="#" id="clear"><i class="fa fa-eraser"></i>Clear
					Map</a></li>
			<li><a href="view/dataGenerator.jsp" id="dataFactoryGenerator"><i
					class="fa fa-wrench"></i>Data Factory</a></li>
			<li><a href="#" id="disaster"><i
					class="fa fa-exclamation-triangle"></i>Disaster Mode<i
					class="fa fa-caret-down"></i></a>
				<ul>
					<li><a href="#" id="disasterMode"><i class="fa fa-circle"></i>Create
							Disaster Mode</a>
					<li><a href="#" id="removeSelectedDisaster"><i
							class="fa fa-ban"></i>Remove Selected Disaster</a>
					<li><a href="#" id="removeAllDisaster"><i
							class="fa fa-ban"></i>Remove All Disasters</a>
				</ul></li>
			<li><a href="#" id="resetDatabase"><i
					class="fa fa-thumbs-up"></i>Reset Database</a></li>
		</ul>
	...
	<div id="container">
		...
		<div id="elementInfo" class='table'>
			...
			<table>
				...
				<tr>
					<td>Holon Element Type:&nbsp;&nbsp;<select
						id="holonElementType"></select></td>
				</tr>
				<tr>
					<td>Holon Element State:&nbsp;&nbsp;<select
						id="holonElementState"></select></td>
				</tr>
				<tr>
					<td>Current Usage/Production:&nbsp;&nbsp;<input
						id="currentCapacity" type="text"></td>
				</tr>
			</table>
			<hr>
			<table>
				<tr>
					<td colspan="2"><input id="cancelElementInfo"
						onclick="closeDiv('elementInfo')" type='button' class="button"
						value='Cancel' />&nbsp;&nbsp;&nbsp;&nbsp; <input
						id="saveElementInfo" type='button' class="button"
		...
		<div id="holonObjectDetail" class='table'>
			...
			<table>
				...
				<tr>
					<td>Holon Object Type: <select name="holonObjectType"
						id="holonObjectType"></select></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;Can Communicate: <select
						name="canCommunicate" id="canCommunicate">
				...
				<tr style="display: none;">
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;Longtitude NE: <label
						id="holonObjectLongitudeNE"></label></td>
				</tr>
				<tr style="display: none;">
					<td>Latitude SW: <label id="holonObjectLatitudeSW"></label></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;Longtitude SW: <label
						id="holonObjectLongitudeSW"></label></td>
				</tr>
			</table>
			<hr>
			<table>
		...
		<div id="powerObjectDetail" class='table'>
			<input type="hidden" id="powerObjectActionState" value="" /> <input
				type="hidden" id="hiddenPowerObjectId" value="" /> <input
				type="hidden" id="hiddenPowerObjectCenterLat" value="" /> <input
				type="hidden" id="hiddenPowerObjectCenterLng" value="" /> <input
				type="hidden" id="hiddenPowerObjectRad" value="" />
			<table class='table'>
				<tr>
					<td id='powerObjTitle' colspan="2"
						style="text-decoration: underline;"></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;Maximum Production
						Capacity:&nbsp;&nbsp;&nbsp;&nbsp;<input id="psMaxProdCap"
						type="text">
					</td>
				</tr>
			</table>
		...
		<div id="lineObjectDetail" class='table'>
			<input type="hidden" id="powerLineObjectActionState" value="" /> <input
				type="hidden" id="powerLineStartLat" value="" /> <input
				type="hidden" id="powerLineStartLng" value="" /> <input
				type="hidden" id="powerLineEndLat" value="" /> <input type="hidden"
				id="powerLineEndLng" value="" /> <input type="hidden"
				id="powerLineIdHidden" value="" /> <input type="hidden"
				id="powerLineHolonObjectIdHidden" value="" /> <input type="hidden"
				id="powerLineIdForSubLine" value="" /> <input type="hidden"
				id="powerLineType" value="" />
			<!-- <table id="powerLineObjectTable"> -->
			<table>
				<tr>
					<td id='powerLineTitle' colspan="2"
						style="text-decoration: underline;"></td>
				</tr>
				<tr>
			...
			<table>
				<tr>
					<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
						id="cancelPowerLine" type='button' class="button" value='Cancel' />
						<input id="savePowerLineObject" type='button' class="button"
						value='Save Power Line' /></td>
				</tr>
			</table>
		</div>
		...
		<div id="divHolonElementsDetail" class='table'>
			...
			<input type="button" id="closeElementList"
				onclick="closeDiv('divHolonElementsDetail')" value="X" />
		</div>
